...
('system', 'Rolled Oats', 'Dry goods'),
('system', 'Chia Seeds', 'Dry goods'),
('system', 'Almond Milk', 'Dairy'),
('system', 'Maple Syrup', 'Other'),
('system', 'Mixed Berries', 'Produce'),
('system', 'Firm Tofu', 'Meat'),
('system', 'Turmeric', 'Spices'),
('system', 'Tortilla Wraps', 'Other'),
('system', 'Spinach', 'Produce'),
('system', 'Black Beans', 'Canned'),
('system', 'Brown Lentils', 'Dry goods'),
('system', 'Potatoes', 'Produce'),
('system', 'Carrots', 'Produce'),
('system', 'Peas', 'Produce'),
('system', 'Vegetable Broth', 'Dry goods'),
('system', 'Canned Chickpeas', 'Canned'),
('system', 'Cucumber', 'Produce'),
('system', 'Cherry Tomatoes', 'Produce'),
('system', 'Kalamata Olives', 'Other'),
('system', 'Olive Oil', 'Other'),
('system', 'Lemon Juice', 'Other'),
('system', 'Canned Tomatoes', 'Canned'),
('system', 'Onion', 'Produce'),
('system', 'Chili Powder', 'Spices'),
('system', 'Sweet Potato', 'Produce'),
('system', 'Bell Pepper', 'Produce'),
('system', 'Coconut Milk', 'Dairy'),
('system', 'Curry Powder', 'Spices'),
('system', 'Brown Rice', 'Dry goods'),
('system', 'Pumpkin Seeds', 'Dry goods'),
('system', 'Tahini', 'Dry goods'),
('system', 'Cannellini Beans', 'Canned'),
('system', 'Kale', 'Produce'),
('system', 'Garlic', 'Produce'),
('system', 'Broccoli', 'Produce'),
('system', 'Soy Sauce', 'Other'),
('system', 'Ginger', 'Produce'),
('system', 'Jasmine Rice', 'Dry goods'),
('system', 'Sesame Oil', 'Other'),
('system', 'Spaghetti', 'Dry goods'),
('system', 'Oregano', 'Spices'),
('system', 'Tempeh', 'Meat'),
('system', 'Snap Peas', 'Produce'),
('system', 'Sesame Seeds', 'Other'),
('system', 'Sweet Corn', 'Canned'),
('system', 'Cilantro', 'Produce'),
('system', 'Lime Juice', 'Other'),
('system', 'Soba Noodles', 'Dry goods'),
('system', 'Peanut Butter', 'Other'),
('system', 'Red Lentils', 'Dry goods'),
('system', 'Red Onion', 'Produce'),
('system', 'Butternut Squash', 'Produce'),
('system', 'Cooked Quinoa', 'Dry goods'),
('system', 'Cumin', 'Spices'),
('system', 'Garlic Powder', 'Spices'),
('system', 'Burger Buns', 'Other'),
('system', 'Shelled Edamame', 'Produce'),
('system', 'Rice Vinegar', 'Other'),
('system', 'Red Kidney Beans', 'Canned'),
('system', 'Chili Flakes', 'Spices');
...
('system', 'Overnight Oats with Chia and Berries', 'Fiber-rich, low-prep breakfast ready in the morning.', '1. Combine rolled oats, chia seeds, and almond milk in a jar.
2. Stir in maple syrup and mix well.
3. Cover and refrigerate overnight.
4. Top with fresh berries before serving.', 2, 1, 1),

('system', 'Tofu Scramble Breakfast Burrito', 'High-protein vegan breakfast wraps, perfect for meal prepping.', '1. Crumble tofu into a bowl and mix with turmeric and salt.
...
('system', 'Classic Lentil Shepherd''s Pie', 'Hearty, comforting protein-packed pie topped with mashed potatoes.', '1. Boil potatoes and mash with olive oil.
...
('system', 'Mediterranean Chickpea Salad', 'Zesty, refreshing, and high-fiber meal-prep salad.', '1. Rinse chickpeas and toss in a large bowl.
2. Add diced cucumber, cherry tomatoes, and sliced kalamata olives.
3. Drizzle with olive oil and lemon juice.
4. Mix well and store in airtight containers.', 2, 1, 4),

('system', 'Spicy Black Bean Chili', 'Smoky, rich, and high-fiber chili that gets better the next day.', '1. Saute diced onion, sweet potato, and bell pepper in a pot.
...
('system', 'Coconut Chickpea Curry', 'Creamy, aromatic, and comforting beginner-friendly curry.', '1. Cook rice and set aside.
...
('system', 'Quinoa Salad with Sweet Potato', 'Nutrient-dense grain salad with sweet potatoes and tahini dressing.', '1. Roast diced sweet potato with olive oil.
...
('system', 'Creamy Tuscan White Bean Soup', 'Garlicky, warm, and highly nutritious white bean and kale soup.', '1. Saute garlic and onion in a large pot.
...
('system', 'Stir-Fry Tofu with Broccoli', 'Easy protein-packed weekday stir-fry with broccoli and rice.', '1. Press and cube tofu, then pan-sear until crispy.
...
('system', 'Lentil Bolognese with Pasta', 'A wholesome, fiber-rich plant-based twist on traditional Bolognese.', '1. Cook spaghetti according to package directions.
...
('system', 'Roasted Veggie Buddah Bowl', 'Bright, colorful veggie bowl packed with fiber and protein.', '1. Roast broccoli and sweet potato on a baking sheet.
...
('system', 'Tempeh Maple-Glazed Stir Fry', 'Nutty, sweet, and savory stir-fry featuring nutrient-dense tempeh.', '1. Slice tempeh and pan-fry in sesame oil until golden.
...
('system', 'Mexican Quinoa Salad', 'Colorful, protein-packed quinoa salad with lime-cilantro dressing.', '1. Rinse and cook quinoa.
...
('system', 'Peanut Noodle Salad with Tofu', 'Flavorful noodle bowl with crispy tofu and a rich peanut dressing.', '1. Cook soba noodles, drain and rinse.
...
('system', 'Red Lentil Dahl', 'Traditional, comforting, protein-rich dahl served over rice.', '1. Heat oil, saute onion, garlic, and ginger.
...
('system', 'Tofu Souvlaki Salad Bowl', 'Mediterranean-inspired tofu bowl with fresh salads.', '1. Marinade cubed tofu in lemon juice, oregano, and olive oil.
...
('system', 'Butternut Squash Soup', 'Silky, sweet, and highly nutritious butternut squash soup.', '1. Saute onion and garlic in a pot.
...
('system', 'Black Bean Quinoa Burgers', 'Wholesome plant-based burger patties that hold together well.', '1. Mash black beans in a bowl.
...
('system', 'Green Edamame Salad', 'Crisp, green, high-protein salad featuring edamame.', '1. Steam edamame and let cool.
...
('system', 'Vegan Chili Sin Carne', 'A thick, protein-heavy chili containing lentils, kidney beans, and corn.', '1. Heat oil in a large pot and saute onion.
